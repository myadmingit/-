...
public class RecruitController {
	...
	public Result findNewList(){
		List<Recruit> StateList = recruitService.findTop6ByStateOrderByCreatetimeDesc("2");
		return new Result(true,StatusCode.OK,"查询成功",StateList);
	}

	@RequestMapping(value = "/search/recommend",method = RequestMethod.GET)
	public Result findRecommend(){
		List<Recruit> notStateList = recruitService.findTop6ByStateNotOrderByCreatetimeDesc("0");
		return new Result(true,StatusCode.OK,"查询成功",notStateList);
	}
	/**
	 * 查询全部数据
	 * @return
